...
CMD_FLAGS = '--public-api --verbose --chat --auto-devices --share --extensions elevenlabs_tts api'
...
def install_dependencies():
    ...
    # run_cmd("git clone https://github.com/krizzlybear/text-generation-webui.git", assert_success=True, environment=True)
    # if sys.platform.startswith("win"):
